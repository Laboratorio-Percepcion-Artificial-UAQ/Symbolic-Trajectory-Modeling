...
%% === Load Video ===
video_path = pwd;
vid = VideoReader(fullfile(video_path,'ViratVideo.mp4')); % https://data.kitware.com/#collection/56f56db28d777f753209ba9f/folder/56f581ce8d777f753209ca43
...
Im_prev       = imresize(Im_prev,Im_factor); 
Im_color      = Im_prev;
...
step_frames      = 3;
min_area         = 30*Im_factor;
cost_threshold   = min_area;
dead_frame_limit = 3 * step_frames;
...
alpha_decay    = (1-1/fps*step_frames);%0.9;
